...
export const THEMATIC_LAYERS = [
  ...
  },
  {
    ...
    kind: 'scale',
    unit: '%',
    // Одна тёплая последовательная шкала, монотонная по светлоте: радуга не
    // имеет естественного порядка — без легенды не сказать, что больше,
    // жёлтый или зелёный, а при дальтонизме её концы сходятся.
    ramp: ['#fdecc8', '#f8ca77', '#f0a049', '#d9682f', '#a63428'],
  ...
  },
  {
    ...
    kind: 'scale',
    unit: '×',
    ramp: ['#e7effc', '#bed4f7', '#7fa9ee', '#3f79dd', '#1c4aa0'],
